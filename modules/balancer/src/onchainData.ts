...
import { SubgraphPoolFragment } from '@balancer-labs/sdk';
...
export async function getOnChainBalances(
    subgraphPoolsOriginal: SubgraphPoolFragment[],
    multiAddress: string,
    vaultAddress: string,
    provider: Provider,
): Promise<SubgraphPoolFragment[]> {
    ...
    const subgraphPools: SubgraphPoolFragment[] = [];
    ...
    const onChainPools: SubgraphPoolFragment[] = [];
